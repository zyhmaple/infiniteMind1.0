package com.im.success.advertiser.form;

import java.util.Date;

import com.opensymphony.xwork2.ActionSupport;

public class AdvertiserForm extends ActionSupport {
	...
	public String getAdr_AgentName() {
		return adr_AgentName;
	}

	public void setAdr_AgentName(String adr_AgentName) {
		this.adr_AgentName = adr_AgentName;
	}
